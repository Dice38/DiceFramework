...
public abstract class DiceAbstractCollection<T> implements Collection<T> {
    ...
    public interface DiceIterator<T> extends Iterator<T> {
        ...
        /**
         * Method to move the DiceIterator to the first element of the DataStructure.
         * A subsequent call to next() would return the first Element.
         */
        public abstract void goToFirst();


        /**
         * Method to move the DiceIterator to the last element of the DataStructure.
         * A subsequent call to previous would return the last Element.
         */
